          ...
          return Scaffold(
              ...
              Center(
                child: Column(
                          ...
                          children: [
                            SvgPicture.asset('assets/images/404.svg', height: 140,),
                  ...
                  itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                            ...
                            builder: (context) => AlertDialog(
                                    ...
                                    actions: <Widget>[
                                      ...
                                      TextButton(
                                          ...
                                          onPressed: () {
                                            //delete the contact
                                            http.delete(Uri.parse( // 'localhost:5000/api/deletecontact'),
                                              'https://birdie-auth-testing.herokuapp.com/api/deletecontact'), //! API HEROKU URL
                                              headers: {'Content-Type':'application/json'},
                                              body: json.encode({'name': name[index]})).then((value) {
                        ...
                        child: ListTile(
                            ...
                            title:
                                Text(name[index], style: GoogleFonts.roboto()),
              ...
              floatingActionButton: Column(
                ...
                children: [
                  Container(
                    ...
                    child: FloatingActionButton.small( // ? Refresh FAB
                        onPressed: (() => setState(() {
                              name.clear();
                              fetchFromAWS = fetchData();
                        })),
                        ...
                        builder: (context) => AlertDialog(
                          ...
                          actions: <Widget>[
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                http.post(
                                    Uri.parse('https://birdie-auth-testing.herokuapp.com/api/addcontact'),
                                    headers: {'Content-Type': 'application/json'},
                                    body: json.encode({'name': dialogContactNameController.text}));
